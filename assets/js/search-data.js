...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/";
          ...
          title: "cv",
          description: "Last updated July 2026. Please see the Linked PDF for the full CV, this page represents a compressed version only.",
          section: "Navigation",
          handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6D%72%62%72%69%65%72%73@%6D%70%69%77%67-%62%65%72%6C%69%6E.%6D%70%67.%64%65", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/https://www.linkedin.com/in/megan-briers/", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/https://orcid.org/0000-0003-3058-4353", "_blank");
        },
      },{
        id: 'social-work',
        title: 'Work',
        section: 'Socials',
        handler: () => {
          window.open("https://imprs.mpiwg-berlin.mpg.de/node/63", "_blank");
        },
      },{
      id: 'light-theme',
